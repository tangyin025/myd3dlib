...
void LuaContext::Init(void)
{
	...
	module(m_State)[
		...
		, class_<my::Rectangle>("Rectangle")
			...
			.def("unionSelf", (my::Rectangle & (my::Rectangle::*)(const my::Rectangle &))&my::Rectangle::unionSelf, luabind::return_reference_to(_1))
			.def("union", (my::Rectangle(my::Rectangle::*)(const my::Vector2 &) const)&my::Rectangle::Union)
			.def("unionSelf", (my::Rectangle & (my::Rectangle::*)(const my::Vector2 &))&my::Rectangle::unionSelf, luabind::return_reference_to(_1))
	...
	module(m_State)[
		...
		, class_<my::Sound3DListener, boost::shared_ptr<my::Sound3DListener> >("Sound3DListener")
			...
			.def("GetOrientation", &my::Sound3DListener::GetOrientation, luabind::pure_out_value(_2) + luabind::pure_out_value(_3))
