...
void LuaContext::Init(void)
{
	...
	module(m_State)[
		...
		, class_<TerrainModifier>("TerrainModifier")
			.def(constructor<Terrain *>())
			.def("Release", &TerrainModifier::Release)
			.def("SetHeight", &TerrainModifier::SetHeight)
			.def("GetHeight", &TerrainModifier::GetHeight, copy(result))
			.def("SetColor", &TerrainModifier::SetColor)
			.def("GetColor", &TerrainModifier::GetColor, copy(result))
			.def("SetNormal", &TerrainModifier::SetNormal)
			.def("GetNormal", &TerrainModifier::GetNormal, copy(result))
