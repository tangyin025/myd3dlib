...
void LuaContext::Init(void)
{
	...
	module(m_State)[
		...
		, class_<ActionTrackVelocity, ActionTrack, boost::shared_ptr<ActionTrack> >("ActionTrackVelocity")
			.def(constructor<float, float>())
			.def_readwrite("ParamStart", &ActionTrackVelocity::m_ParamStart)
			.def_readwrite("ParamLength", &ActionTrackVelocity::m_ParamLength)
		...
		, class_<ActionTrackPose, ActionTrack, boost::shared_ptr<ActionTrack> >("ActionTrackPose")
			...
			.def_readwrite("ParamStart", &ActionTrackPose::m_ParamStart)
			.def_readwrite("ParamLength", &ActionTrackPose::m_ParamLength)
