...
void LuaContext::Init(void)
{
	...
	module(m_State)[
		...
		, class_<my::Quaternion>("Quaternion")
			...
			.def_readwrite("xyz", &my::Quaternion::xyz, copy(result))
			.def(-const_self)
		...
		, class_<my::Matrix4>("Matrix4")
			.def(constructor<float>())
			.property("row0", &my::Matrix4::getRow<0>, &my::Matrix4::setRow<0>, copy(result))
			.property("row1", &my::Matrix4::getRow<1>, &my::Matrix4::setRow<1>, copy(result))
			.property("row2", &my::Matrix4::getRow<2>, &my::Matrix4::setRow<2>, copy(result))
			.property("row3", &my::Matrix4::getRow<3>, &my::Matrix4::setRow<3>, copy(result))
	...
	module(m_State)[
		...
		, class_<my::UIRender>("UIRender")
			...
			.def("PushRectangle", (void (my::UIRender::*)(const my::Rectangle&, const my::Rectangle&, D3DCOLOR, const my::BaseTexture*))& my::UIRender::PushRectangle)
			.def("PushRectangle", (void (my::UIRender::*)(const my::Rectangle&, const my::Rectangle&, D3DCOLOR, const my::BaseTexture*, const my::Rectangle&))& my::UIRender::PushRectangle)
			.def("PushRectangle", (void (my::UIRender::*)(const my::Rectangle&, const my::Rectangle&, D3DCOLOR, const my::BaseTexture*, const my::Matrix4&))& my::UIRender::PushRectangle)
			.def("PushRectangle", (void (my::UIRender::*)(const my::Rectangle&, const my::Rectangle&, D3DCOLOR, const my::BaseTexture*, const my::Matrix4&, const my::Rectangle&))& my::UIRender::PushRectangle)
