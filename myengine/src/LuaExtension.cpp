...
void LuaContext::Init(void)
{
	...
	module(m_State)[
		...
		, class_<my::Vector2>("Vector2")
			...
			.def("lerpSelf", &my::Vector2::lerpSelf, luabind::return_reference_to(boost::placeholders::_1))
			.property("normalize", &my::Vector2::normalize)
			.def("normalizeSelf", &my::Vector2::normalizeSelf, luabind::return_reference_to(boost::placeholders::_1))
		...
		, class_<my::Vector3>("Vector3")
			...
			.def_readwrite("xy", &my::Vector3::xy, luabind::copy(luabind::result))
			...
			.def("lerpSelf", &my::Vector3::lerpSelf, luabind::return_reference_to(boost::placeholders::_1))
			.property("normalize", &my::Vector3::normalize)
			.property("normalize2D", &my::Vector3::normalize2D)
			.def("normalizeSelf", &my::Vector3::normalizeSelf, luabind::return_reference_to(boost::placeholders::_1))
		...
		, class_<my::Vector4>("Vector4")
			...
			.def_readwrite("xy", &my::Vector4::xy, luabind::copy(luabind::result))
			.def_readwrite("xyz", &my::Vector4::xyz, luabind::copy(luabind::result))
			...
			.def("lerpSelf", &my::Vector4::lerpSelf, luabind::return_reference_to(boost::placeholders::_1))
			.property("normalize", &my::Vector4::normalize)
			.def("normalizeSelf", &my::Vector4::normalizeSelf, luabind::return_reference_to(boost::placeholders::_1))
		...
		, class_<my::Rectangle>("Rectangle")
			...
			.def("intersectSelf", &my::Rectangle::intersectSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("union", (my::Rectangle(my::Rectangle::*)(const my::Rectangle &) const)&my::Rectangle::Union)
			.def("unionSelf", (my::Rectangle & (my::Rectangle::*)(const my::Rectangle &))&my::Rectangle::unionSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("union", (my::Rectangle(my::Rectangle::*)(const my::Vector2 &) const)&my::Rectangle::Union)
			.def("unionSelf", (my::Rectangle & (my::Rectangle::*)(const my::Vector2 &))&my::Rectangle::unionSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("offset", (my::Rectangle(my::Rectangle::*)(float, float) const)&my::Rectangle::offset)
			.def("offsetSelf", (my::Rectangle & (my::Rectangle::*)(float, float))&my::Rectangle::offsetSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("offset", (my::Rectangle(my::Rectangle::*)(const my::Vector2 &) const)&my::Rectangle::offset)
			.def("offsetSelf", (my::Rectangle & (my::Rectangle::*)(const my::Vector2 &))&my::Rectangle::offsetSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("shrink", (my::Rectangle(my::Rectangle::*)(float, float) const)&my::Rectangle::shrink)
			.def("shrinkSelf", (my::Rectangle & (my::Rectangle::*)(float, float))&my::Rectangle::shrinkSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("shrink", (my::Rectangle(my::Rectangle::*)(const my::Vector2 &) const)&my::Rectangle::shrink)
			.def("shrinkSelf", (my::Rectangle & (my::Rectangle::*)(const my::Vector2 &))&my::Rectangle::shrinkSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("shrink", (my::Rectangle(my::Rectangle::*)(float, float, float, float) const)&my::Rectangle::shrink)
			.def("shrinkSelf", (my::Rectangle & (my::Rectangle::*)(float, float, float, float))&my::Rectangle::shrinkSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("shrink", (my::Rectangle(my::Rectangle::*)(const my::Vector4 &) const)&my::Rectangle::shrink)
			.def("shrinkSelf", (my::Rectangle & (my::Rectangle::*)(const my::Vector4 &))&my::Rectangle::shrinkSelf, luabind::return_reference_to(boost::placeholders::_1))
		...
		, class_<my::Quaternion>("Quaternion")
			...
			.def_readwrite("xyz", &my::Quaternion::xyz, luabind::copy(luabind::result))
			.def(-const_self)
			...
			.def("conjugateSelf", &my::Quaternion::conjugateSelf, luabind::return_reference_to(boost::placeholders::_1))
			...
			.def("normalizeSelf", &my::Quaternion::normalizeSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("lerp", &my::Quaternion::lerp)
			.def("lerpSelf", &my::Quaternion::lerpSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("slerp", &my::Quaternion::slerp)
			.def("slerpSelf", &my::Quaternion::slerpSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("squad", &my::Quaternion::squad)
			.def("squadSelf", &my::Quaternion::squadSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("toAxisAngle", &my::Quaternion::toAxisAngle, luabind::pure_out_value(boost::placeholders::_2) + luabind::pure_out_value(boost::placeholders::_3))
		...
		, class_<my::Matrix4>("Matrix4")
			...
			.property("row0", &my::Matrix4::getRow<0>, &my::Matrix4::setRow<0>, luabind::copy(luabind::result))
			.property("row1", &my::Matrix4::getRow<1>, &my::Matrix4::setRow<1>, luabind::copy(luabind::result))
			.property("row2", &my::Matrix4::getRow<2>, &my::Matrix4::setRow<2>, luabind::copy(luabind::result))
			.property("row3", &my::Matrix4::getRow<3>, &my::Matrix4::setRow<3>, luabind::copy(luabind::result))
			...
			.def("scaleSelf", (my::Matrix4 & (my::Matrix4::*)(float, float, float))&my::Matrix4::scaleSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("scaleSelf", (my::Matrix4 & (my::Matrix4::*)(const my::Vector3 &))&my::Matrix4::scaleSelf, luabind::return_reference_to(boost::placeholders::_1))
			...
			.def("translateSelf", (my::Matrix4 & (my::Matrix4::*)(float, float, float))&my::Matrix4::translateSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("translateSelf", (my::Matrix4 & (my::Matrix4::*)(const my::Vector3 &))&my::Matrix4::translateSelf, luabind::return_reference_to(boost::placeholders::_1))
		...
		, class_<my::AABB>("AABB")
			...
			.def("validSelf", &my::AABB::validSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def(self == other<const my::AABB &>())
			...
			.def("unionSelf", (my::AABB& (my::AABB::*)(const my::Vector3&))&my::AABB::unionSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("union", (my::AABB (my::AABB::*)(const my::AABB&) const)&my::AABB::Union)
			.def("unionSelf", (my::AABB& (my::AABB::*)(const my::AABB&))&my::AABB::unionSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("shrink", &my::AABB::shrink)
			.def("shrinkSelf", &my::AABB::shrinkSelf, luabind::return_reference_to(boost::placeholders::_1))
			.def("p", &my::AABB::p)
			.def("n", &my::AABB::n)
			.def("transform", &my::AABB::transform)
			.def("transformSelf", &my::AABB::transformSelf, luabind::return_reference_to(boost::placeholders::_1))
	...
	module(m_State)[
		...
		, class_<my::ControlSkin, boost::shared_ptr<my::ControlSkin> >("ControlSkin")
			...
			.def_readwrite("TextOutlineColor", &my::ControlSkin::m_TextOutlineColor)
			.def_readwrite("TextOutlineWidth", &my::ControlSkin::m_TextOutlineWidth)
	...
	module(m_State)[
		...
		, class_<my::Sound3DListener, boost::shared_ptr<my::Sound3DListener> >("Sound3DListener")
			...
			.def("GetOrientation", &my::Sound3DListener::GetOrientation, luabind::pure_out_value(boost::placeholders::_2) + luabind::pure_out_value(boost::placeholders::_3))
	...
	module(m_State)[
		...
		, class_<CircularEmitter, EmitterComponent, boost::shared_ptr<Component> >("CircularEmitter")
			...
			.def_readonly("ParticleList", &CircularEmitter::m_ParticleList, luabind::return_stl_iterator)
		...
		, class_<TerrainStream>("TerrainStream")
			...
			.def("GetIndices", &TerrainStream::GetIndices, luabind::pure_out_value(boost::placeholders::_4) + luabind::pure_out_value(boost::placeholders::_5) + luabind::pure_out_value(boost::placeholders::_6) + luabind::pure_out_value(boost::placeholders::_7) + luabind::pure_out_value(boost::placeholders::_8) + luabind::pure_out_value(boost::placeholders::_9))
			.def("GetPos", &TerrainStream::GetPos, copy(result))
			.def("SetPos", (void(TerrainStream::*)(const my::Vector3 &, int, int))&TerrainStream::SetPos)
		...
		, class_<Controller, Component, boost::shared_ptr<Component> >("Controller")
			...
			.def_readonly("Height", &Controller::m_Height)
			.def_readonly("Radius", &Controller::m_Radius)
			.def_readonly("ContactOffset", &Controller::m_ContactOffset)
		...
		, class_<Actor, bases<my::NamedObject, my::OctEntity>, boost::shared_ptr<Actor> >("Actor")
			...
			.def("SetPose", (void (Actor::*)(const my::Vector3&, const my::Quaternion&, const my::Vector3&))& Actor::SetPose)
		...
		, class_<Animator, bases<Component, AnimationNodeSlot>, boost::shared_ptr<Component> >("Animator") // ! luabind::bases for accessing AnimationNodeSlot properties from boost::shared_ptr<Component>
			...
			.def_readonly("anim_pose_hier", &Animator::anim_pose_hier, luabind::return_stl_iterator)
