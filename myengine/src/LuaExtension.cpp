...
void LuaContext::Init(void)
{
	...
	module(m_State)[
		...
		, class_<my::Vector3>("Vector3")
			...
			.def("magnitude2D", &my::Vector3::magnitude2D)
			.def("magnitudeSq2D", &my::Vector3::magnitudeSq2D)
	...
	module(m_State)[
		...
		, class_<my::Clock>("Clock")
			...
			.def("Reset", &my::Clock::Reset)
			.def("Start", &my::Clock::Start)
			.def("Stop", &my::Clock::Stop)
