...
void LuaContext::Init(void)
{
	...
	module(m_State)[
		...
		, class_<my::Joystick, boost::shared_ptr<my::Joystick> >("Joystick")
			...
			.def("GetX", &my::Joystick::GetX)
			.def("GetY", &my::Joystick::GetY)
			.def("GetZ", &my::Joystick::GetZ)
			.def("GetRx", &my::Joystick::GetRx)
			.def("GetRy", &my::Joystick::GetRy)
			.def("GetRz", &my::Joystick::GetRz)
	...
	module(m_State)[
		...
		, class_<Terrain, Component, boost::shared_ptr<Component> >("Terrain")
			.def(constructor<const char *, int, int, int, float>())
		...
		, class_<TerrainStream>("TerrainStream")
			.def(constructor<Terrain *, bool>())
			.def_readonly("OverwriteStream", &TerrainStream::m_OverwriteStream)
		...
		, class_<AnimationRoot, Component/*, AnimationNodeSlot*/, boost::shared_ptr<Component> >("AnimationRoot")
			.def(constructor<const char*>())
			.property("Child0", &AnimationRoot::GetChild<0>, &AnimationRoot::SetChild<0>)
			.property("Child1", &AnimationRoot::GetChild<1>, &AnimationRoot::SetChild<1>)
