...
void LuaContext::Init(void)
{
	...
	module(m_State)[
		...
		, class_<my::UIRender>("UIRender")
			...
			.def("PushRectangle", (void (my::UIRender::*)(const my::Rectangle&, D3DCOLOR, const CRect&, const my::BaseTexture*))& my::UIRender::PushRectangle)
			.def("PushRectangle", (void (my::UIRender::*)(const my::Rectangle&, D3DCOLOR, const CRect&, const my::BaseTexture*, const my::Rectangle&))& my::UIRender::PushRectangle)
	...
	module(m_State)[
		...
		, class_<AnimationNodeSequence, AnimationNode, boost::shared_ptr<AnimationNode> >("AnimationNodeSequence")
			...
			.property("Time", &AnimationNodeSequence::m_Time)
