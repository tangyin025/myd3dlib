...
void LuaContext::Init(void)
{
	...
	module(m_State)[
		...
		, class_<Component, my::NamedObject, boost::shared_ptr<Component> >("Component")
			...
			.def_readonly("MaterialList", &Component::m_MaterialList, luabind::return_stl_iterator)
			.def("SetMaterial", &Component::SetMaterial)
			.def("GetMaterial", &Component::GetMaterial)
			.def("AddMaterial", &Component::AddMaterial)
