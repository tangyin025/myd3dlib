...
size_t UIElement::BuildQuadrangleVertices(
...
void UIElement::Begin(IDirect3DDevice9 * pd3dDevice)
{
...
void UIElement::End(IDirect3DDevice9 * pd3dDevice)
{
...
void UIElement::OnRender(IDirect3DDevice9 * pd3dDevice, float fElapsedTime)
{
	...
	size_t vertNum = BuildQuadrangleVertices(
		vertex_list, _countof(vertex_list), my::Rectangle::LeftTop(100,100,100,100), D3DCOLOR_ARGB(255,255,255,255), my::Rectangle(0,0,1,1));
