...
//--------------------------------------------------------------------------------------
HRESULT WINAPI DXUTFindValidDeviceSettings( DXUTD3D9DeviceSettings* pOut, DXUTD3D9DeviceSettings* pIn,
                                            DXUTMatchOptions* pMatchOptions )
{
    HRESULT hr = S_OK;
    ...
    CopyMemory( &validDeviceSettings, pIn, sizeof( DXUTD3D9DeviceSettings ) );
    ...
    //if( bAppSupportsD3D9 && !bFoundValidD3D10 && !bAvoidD3D9 )
    {
        ...
        DXUTBuildOptimalD3D9DeviceSettings( &optimalDeviceSettings, &d3d9In, pMatchOptions );

        //validDeviceSettings.ver = DXUT_D3D9_DEVICE;
        hr = DXUTFindValidD3D9DeviceSettings( &validDeviceSettings, &d3d9In,
                                              pMatchOptions, &optimalDeviceSettings );
        if( SUCCEEDED( hr ) )
...
CD3D9Enumeration* WINAPI DXUTGetD3D9Enumeration( bool bForceEnumerate )
{
    ...
    {
        LPDXUTCALLBACKISD3D9DEVICEACCEPTABLE pCallbackIsDeviceAcceptable = NULL;
