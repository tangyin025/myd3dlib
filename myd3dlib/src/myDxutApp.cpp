...
WCHAR * DxutApp::DXUTD3DDeviceTypeToString(D3DDEVTYPE devType)
{
	switch( devType )
	{
	case D3DDEVTYPE_HAL:
...
LPCWSTR DxutApp::DXUTD3DFormatToString(D3DFORMAT format, bool bWithPrefix)
{
	WCHAR* pstr = NULL;
	switch( format )
	{
...
WCHAR * DxutApp::DXUTMultisampleTypeToString(D3DMULTISAMPLE_TYPE MultiSampleType)
{
...
WCHAR * DxutApp::DXUTVertexProcessingTypeToString(DWORD vpt)
{
	switch( vpt )
	{
