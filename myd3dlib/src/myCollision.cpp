...
namespace my
{
	...
	//{
	//	return (float)4.0 / (float)3.0 * (float)PI * radius * radius * radius;
	//}

	//BoundingSphere buildBoundingSphere(const BoundingSphere & lhs, const BoundingSphere & rhs)
	//{
	//	Vector3 centerOffset = t3d::vec3Sub(lhs.getCenter(), rhs.getCenter());
	//	float distanceSquare = t3d::vec3LengthSquare(centerOffset);
	...
	//		Vector3 newCenter = t3d::vec3Add(lhs.getCenter(), t3d::vec3Mul(centerOffset, (newRadius - lhs.getRadius()) / distance));
