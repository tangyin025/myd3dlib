...
BOOL CMainApp::InitInstance()
{
	...
	desc.add_options()
		...
		("default_listbox_text_color", boost::program_options::value<D3DCOLOR>(&default_listbox_text_color)->default_value(D3DCOLOR_ARGB(255,0,0,0)), "Default listbox text color")
		...
		("default_listbox_mouseoverimg", boost::program_options::value(&default_listbox_mouseoverimg)->default_value("texture/White.dds"), "Default listbox mouseoverimg")
		("default_listbox_mouseoverimg_rect", boost::program_options::value<my::Rectangle>(&default_listbox_mouseoverimg_rect)->default_value(my::Rectangle::LeftTop(1,1,2,2), ""), "Default listbox mouseoverimg rect")
		("default_listbox_mouseoverimg_border", boost::program_options::value<my::Vector4>(&default_listbox_mouseoverimg_border)->default_value(my::Vector4(0,0,0,0), ""), "Default listbox mouseoverimg border")
