...
BOOL CMainApp::InitInstance()
{
	...
	desc.add_options()
		...
		("default_enable_mouse_tracker", boost::program_options::value(&default_enable_mouse_tracker)->default_value(true), "Default enable mouse tracker")
		("default_remaining_actor_max", boost::program_options::value(&default_remaining_actor_max)->default_value(1024), "Default remaining actor max")
