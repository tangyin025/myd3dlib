...
BOOL CMainApp::InitInstance()
{
	...
	desc.add_options()
		...
		("default_physx_scene_flags", boost::program_options::value(&default_physx_scene_flags)->default_value(physx::PxSceneFlag::eENABLE_PCM | physx::PxSceneFlag::eENABLE_ACTIVETRANSFORMS /*| physx::PxSceneFlag::eEXCLUDE_KINEMATICS_FROM_ACTIVE_ACTORS*/ | physx::PxSceneFlag::eENABLE_CCD), "Default physx scene flags")
		("default_physx_scene_gravity", boost::program_options::value(&default_physx_scene_gravity)->default_value(my::Vector3(0, -19.6f, 0), ""), "Default physx scene gravity")
		...
		("default_grid_divisions", boost::program_options::value(&default_grid_divisions)->default_value(12), "Default grid divisions")
		...
		("default_ui_grid_size", boost::program_options::value(&default_ui_grid_size)->default_value(5.0f), "Default ui grid size")
		...
		("default_specular_texture", boost::program_options::value(&default_specular_texture)->default_value("texture/Gray.dds"), "Default specular texture")
		...
		("default_static_img", boost::program_options::value(&default_static_img)->default_value("texture/White.dds"), "Default static img")
		("default_static_img_rect", boost::program_options::value<CRect>(&default_static_img_rect)->default_value(CRect(1, 1, 3, 3), ""), "Default static img rect")
		("default_static_img_border", boost::program_options::value<CRect>(&default_static_img_border)->default_value(CRect(0, 0, 0, 0), ""), "Default static img border")
		...
		("default_player_mesh", boost::program_options::value(&default_player_mesh), "Default player mesh")
		("default_player_skel", boost::program_options::value(&default_player_skel), "Default player skel")
		...
		("default_player_slope_limit", boost::program_options::value(&default_player_slope_limit)->default_value(my::Max(0.0f, cosf(D3DXToRadian(90)))), "default player slope limit")
