...
void Export2Lua(lua_State * L)
{
	...
	[
		...
		, class_<TerrainComponent, RenderComponent, boost::shared_ptr<Component> >("TerrainComponent")
			.def(constructor<const my::Vector3 &, const my::Vector3 &, const my::Vector2 &, const my::Vector2 &, unsigned int, unsigned int, const my::Matrix4 &>())
			.def(constructor<>())
			.def_readwrite("PosStart", &TerrainComponent::m_PosStart)
			.def_readwrite("PosEnd", &TerrainComponent::m_PosEnd)
