...
void CMainView::OnPaint()
{
	...
	if(m_d3dSwapChain)
	{
		...
		if(SUCCEEDED(hr = pd3dDevice->BeginScene()))
		{
			...
			ui_render.SetView(my::UIRender::PerspectiveView(D3DXToRadian(75.0f), (float)desc.Width, (float)desc.Height));
			ui_render.SetProj(my::UIRender::PerspectiveProj(D3DXToRadian(75.0f), (float)desc.Width, (float)desc.Height));
			ui_render.Begin();
