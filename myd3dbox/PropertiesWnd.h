...
public:
	...
	enum Property
	{
		...
		PropertyListBoxMouseOverImageRectTop,
		PropertyListBoxMouseOverImageRectWidth,
		PropertyListBoxMouseOverImageRectHeight,
		PropertyListBoxMouseOverImageBorder,
		PropertyListBoxMouseOverImageBorderX,
		PropertyListBoxMouseOverImageBorderY,
		PropertyListBoxMouseOverImageBorderZ,
		PropertyListBoxMouseOverImageBorderW,
