...
public:
	...
	enum Property
	{
		...
		PropertyActorRigidActorMass,
		PropertyActorRigidActorCMassLocalPos,
		PropertyActorRigidActorCMassLocalPosX,
		PropertyActorRigidActorCMassLocalPosY,
		PropertyActorRigidActorCMassLocalPosZ,
		PropertyActorRigidActorCMassLocalRot,
		PropertyActorRigidActorCMassLocalRotX,
		PropertyActorRigidActorCMassLocalRotY,
		PropertyActorRigidActorCMassLocalRotZ,
		PropertyActorRigidActorMassSpaceInertiaTensor,
		PropertyActorRigidActorMassSpaceInertiaTensorX,
		PropertyActorRigidActorMassSpaceInertiaTensorY,
		PropertyActorRigidActorMassSpaceInertiaTensorZ,
		PropertyActorRigidActorLinearDamping,
		PropertyActorRigidActorAngularDamping,
		PropertyActorRigidActorMaxAngularVelocity,
		PropertyComponent,
		...
		PropertyMaterialParameterTexturePath,
		PropertyMaterialParameterTextureLevelCount,
		PropertyMaterialParameterTextureFormat,
		PropertyMaterialParameterTextureWidth,
		PropertyMaterialParameterTextureHeight,
		...
		PropertyAnimatorRootPosition,
		PropertyAnimatorRootPositionX,
		PropertyAnimatorRootPositionY,
		PropertyAnimatorRootPositionZ,
		PropertyAnimatorRootRotation,
		PropertyAnimatorRootRotationX,
		PropertyAnimatorRootRotationY,
		PropertyAnimatorRootRotationZ,
