...
CNavigationDlg::CNavigationDlg(CWnd* pParent /*=NULL*/)
	...
	, m_cellSize(0.3f)
	, m_cellHeight(0.2f)
	, m_agentHeight(theApp.default_player_height + theApp.default_player_radius * 2.0f + theApp.default_player_contact_offset * 2.0f)
	, m_agentRadius(theApp.default_player_radius)
	, m_agentMaxClimb(theApp.default_player_step_offset)
