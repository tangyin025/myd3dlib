...
void CMainFrame::OnControlCombobox()
{
	...
	skin->m_ScrollBarUpBtnNormalImage->m_TexturePath = theApp.default_combobox_scrollbarupbtn_normalimg;
	skin->m_ScrollBarUpBtnNormalImage->m_Rect = theApp.default_combobox_scrollbarupbtn_normalimg_rect;
	skin->m_ScrollBarUpBtnNormalImage->m_Border = theApp.default_combobox_scrollbarupbtn_normalimg_border;
	skin->m_ScrollBarUpBtnDisabledImage.reset(new my::ControlImage());
	skin->m_ScrollBarUpBtnDisabledImage->m_TexturePath = theApp.default_combobox_scrollbarupbtn_disabledimg;
	skin->m_ScrollBarUpBtnDisabledImage->m_Rect = theApp.default_combobox_scrollbarupbtn_disabledimg_rect;
	skin->m_ScrollBarUpBtnDisabledImage->m_Border = theApp.default_combobox_scrollbarupbtn_disabledimg_border;
	skin->m_ScrollBarDownBtnNormalImage.reset(new my::ControlImage());
	skin->m_ScrollBarDownBtnNormalImage->m_TexturePath = theApp.default_combobox_scrollbardownbtn_normalimg;
	skin->m_ScrollBarDownBtnNormalImage->m_Rect = theApp.default_combobox_scrollbardownbtn_normalimg_rect;
	skin->m_ScrollBarDownBtnNormalImage->m_Border = theApp.default_combobox_scrollbardownbtn_normalimg_border;
	skin->m_ScrollBarDownBtnDisabledImage.reset(new my::ControlImage());
	skin->m_ScrollBarDownBtnDisabledImage->m_TexturePath = theApp.default_combobox_scrollbardownbtn_disabledimg;
	skin->m_ScrollBarDownBtnDisabledImage->m_Rect = theApp.default_combobox_scrollbardownbtn_disabledimg_rect;
	skin->m_ScrollBarDownBtnDisabledImage->m_Border = theApp.default_combobox_scrollbardownbtn_disabledimg_border;
	skin->m_ScrollBarThumbBtnNormalImage.reset(new my::ControlImage());
	skin->m_ScrollBarThumbBtnNormalImage->m_TexturePath = theApp.default_combobox_scrollbarthumbbtn_normalimg;
	skin->m_ScrollBarThumbBtnNormalImage->m_Rect = theApp.default_combobox_scrollbarthumbbtn_normalimg_rect;
	skin->m_ScrollBarThumbBtnNormalImage->m_Border = theApp.default_combobox_scrollbarthumbbtn_normalimg_border;
	skin->m_ScrollBarImage.reset(new my::ControlImage());
	skin->m_ScrollBarImage->m_TexturePath = theApp.default_combobox_scrollbar_img;
...
void CMainFrame::OnControlListbox()
{
	...
	skin->m_ScrollBarUpBtnNormalImage->m_Border = theApp.default_listbox_scrollbarupbtn_normalimg_border;
	skin->m_ScrollBarUpBtnDisabledImage.reset(new my::ControlImage());
	skin->m_ScrollBarUpBtnDisabledImage->m_TexturePath = theApp.default_listbox_scrollbarupbtn_disabledimg;
	skin->m_ScrollBarUpBtnDisabledImage->m_Rect = theApp.default_listbox_scrollbarupbtn_disabledimg_rect;
	skin->m_ScrollBarUpBtnDisabledImage->m_Border = theApp.default_listbox_scrollbarupbtn_disabledimg_border;
	skin->m_ScrollBarDownBtnNormalImage.reset(new my::ControlImage());
	skin->m_ScrollBarDownBtnNormalImage->m_TexturePath = theApp.default_listbox_scrollbardownbtn_normalimg;
	skin->m_ScrollBarDownBtnNormalImage->m_Rect = theApp.default_listbox_scrollbardownbtn_normalimg_rect;
	skin->m_ScrollBarDownBtnNormalImage->m_Border = theApp.default_listbox_scrollbardownbtn_normalimg_border;
	skin->m_ScrollBarDownBtnDisabledImage.reset(new my::ControlImage());
	skin->m_ScrollBarDownBtnDisabledImage->m_TexturePath = theApp.default_listbox_scrollbardownbtn_disabledimg;
	skin->m_ScrollBarDownBtnDisabledImage->m_Rect = theApp.default_listbox_scrollbardownbtn_disabledimg_rect;
	skin->m_ScrollBarDownBtnDisabledImage->m_Border = theApp.default_listbox_scrollbardownbtn_disabledimg_border;
	skin->m_ScrollBarThumbBtnNormalImage.reset(new my::ControlImage());
	skin->m_ScrollBarThumbBtnNormalImage->m_TexturePath = theApp.default_listbox_scrollbarthumbbtn_normalimg;
	skin->m_ScrollBarThumbBtnNormalImage->m_Rect = theApp.default_listbox_scrollbarthumbbtn_normalimg_rect;
	skin->m_ScrollBarThumbBtnNormalImage->m_Border = theApp.default_listbox_scrollbarthumbbtn_normalimg_border;
	skin->m_ScrollBarImage.reset(new my::ControlImage());
	skin->m_ScrollBarImage->m_TexturePath = theApp.default_listbox_scrollbar_img;
