...
DWORD ScaleTable[] = { 32000, 16000, 12000, 8000, 7000, 6000, 5000, 4000, 3000, 2000, 1000, 667, 500, 333, 250, 167, 125, 83, 62, 50, 40, 30, 20, 15, 10, 7 };
...
void CImageView::UpdateScrollSize(void)
{
	...
	dc.SetWindowOrg(CPoint(0,0));
	dc.SetWindowExt(CSize(1000,1000));
	dc.SetViewportOrg(CPoint(0,0));
	dc.SetViewportExt(CSize(ScaleTable[m_ScaleIdx],ScaleTable[m_ScaleIdx]));
