...
float4 TransformPosWS(VS_INPUT In)
{
	...
	float3 Offset = RotateAngleAxis(
		float3(-In.Pos0.y * In.SizeAngleTime.x * g_EmitterScale.x, In.Pos0.x * In.SizeAngleTime.y * g_EmitterScale.y, In.Pos0.z * In.SizeAngleTime.x * g_EmitterScale.z), In.SizeAngleTime.z, float3(0, 1, 0));
#elif EMITTER_FACE_TYPE == 2
	float3 Offset = RotateAngleAxis(
		float3(-In.Pos0.z * In.SizeAngleTime.x * g_EmitterScale.x, In.Pos0.y * In.SizeAngleTime.y * g_EmitterScale.y, In.Pos0.x * In.SizeAngleTime.x * g_EmitterScale.z), In.SizeAngleTime.z, float3(0, 0, 1));
	...
	float3 Offset = RotateAngleAxis(
		Right * -In.Pos0.z * In.SizeAngleTime.x * g_EmitterScale.x + Up * In.Pos0.y * In.SizeAngleTime.y * g_EmitterScale.y + Dir * In.Pos0.x * In.SizeAngleTime.x * g_EmitterScale.z, In.SizeAngleTime.z, Dir);
	...
	float3 Offset =
		Right * -In.Pos0.z * In.SizeAngleTime.x * g_EmitterScale.x + Up * In.Pos0.y * In.SizeAngleTime.y * g_EmitterScale.y + Dir * In.Pos0.x * In.SizeAngleTime.x * g_EmitterScale.z;
