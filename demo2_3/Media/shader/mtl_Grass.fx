...
{
	perGrassPivotPosWS = mul(In.Pos, g_World).xyz;//we pre-transform to posWS in C# now
	...
	positionOS = In.Pos0.x * cameraTransformRightWS * _GrassWidth * (sin(perGrassPivotPosWS.x*95.4643 + perGrassPivotPosWS.z) * 0.45 + 0.55);//random width from posXZ, min 0.1
