...
game:AddActor(actor)
local cmp=game:CreateMeshComponentFromFile(actor,"mesh/casual19_m_highpoly.mesh.xml",AABB(-50,50),Matrix4.Scaling(0.05,0.05,0.05),false)
cmp.Animator=game:CreateAnimatorFromFile(actor,"mesh/casual19_m_highpoly.skeleton.xml")
