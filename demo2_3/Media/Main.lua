...
local cmp5=StaticEmitterComponent(NamedObject.MakeUniqueName("mesh_cmp"),1,EmitterComponent.FaceTypeCamera,EmitterComponent.SpaceTypeLocal,EmitterComponent.PrimitiveTypeQuad)
