...
client:LoadSceneAsync("scene01.xml", "scene01_", function(res)
	...
	function actor1Behavior:RequestResource()
		...
		self.hobstacle=SPlayer.obstacles:AddBoxObstacle(self.Actor.Position,self.Actor.Rotation,self.Actor.Scale.x*0.5,self.Actor.Scale.y*0.5,self.Actor.Scale.z*0.5)
	end
	function actor1Behavior:ReleaseResource()
		SPlayer.obstacles:RemoveObstacle(self.hobstacle)
		Component.ReleaseResource(self)
	end
	function actor1Behavior:Update(elapsedTime)
		SPlayer.obstacles:UpdateBoxObstacle(self.hobstacle,self.Actor.Position,self.Actor.Rotation,self.Actor.Scale.x*0.5,self.Actor.Scale.y*0.5,self.Actor.Scale.z*0.5)
	end
