...
btn_toggle_fs.Skin.Image.Rect=CRect(CPoint(52,43),CSize(16,16))
btn_toggle_fs.Skin.Image.Border=CRect(7,7,7,7)
btn_toggle_fs.Skin.FontPath="font/SourceHanSansCN-Regular.otf"
...
btn_toggle_fs.Skin.DisabledImage.Rect=CRect(CPoint(1,43),CSize(16,16))
btn_toggle_fs.Skin.DisabledImage.Border=CRect(7,7,7,7)
btn_toggle_fs.Skin.PressedImage=ControlImage()
btn_toggle_fs.Skin.PressedImage.TexturePath="texture/CommonUI.png"
btn_toggle_fs.Skin.PressedImage.Rect=CRect(CPoint(18,43),CSize(16,16))
btn_toggle_fs.Skin.PressedImage.Border=CRect(7,7,7,7)
btn_toggle_fs.Skin.MouseOverImage=ControlImage()
btn_toggle_fs.Skin.MouseOverImage.TexturePath="texture/CommonUI.png"
btn_toggle_fs.Skin.MouseOverImage.Rect=CRect(CPoint(35,43),CSize(16,16))
btn_toggle_fs.Skin.MouseOverImage.Border=CRect(7,7,7,7)
