...
dlg.Skin.VisibleShowSoundPath="sound/15.wav"
dlg.Skin.Image=ControlImage()
dlg.Skin.Image.TexturePath="texture/CommonUI.png"
dlg.Skin.Image.Rect=CRect(CPoint(158,43),CSize(2,2))
dlg.Skin.Image.Border=CRect(0,0,0,0)
...
lbl_title.Skin=StaticSkin()
lbl_title.Skin.Image=ControlImage()
lbl_title.Skin.Image.TexturePath="texture/CommonUI.png"
lbl_title.Skin.Image.Rect=CRect(CPoint(0,0),CSize(256,42))
lbl_title.Skin.Image.Border=CRect(0,0,0,0)
...
btn_ok.Skin.Image.Rect=CRect(CPoint(52,43),CSize(16,16))
btn_ok.Skin.Image.Border=CRect(7,7,7,7)
btn_ok.Skin.FontPath="font/SourceHanSansCN-Regular.otf"
...
btn_ok.Skin.DisabledImage.Rect=CRect(CPoint(1,43),CSize(16,16))
btn_ok.Skin.DisabledImage.Border=CRect(7,7,7,7)
btn_ok.Skin.PressedImage=ControlImage()
btn_ok.Skin.PressedImage.TexturePath="texture/CommonUI.png"
btn_ok.Skin.PressedImage.Rect=CRect(CPoint(18,43),CSize(16,16))
btn_ok.Skin.PressedImage.Border=CRect(7,7,7,7)
btn_ok.Skin.MouseOverImage=ControlImage()
btn_ok.Skin.MouseOverImage.TexturePath="texture/CommonUI.png"
btn_ok.Skin.MouseOverImage.Rect=CRect(CPoint(35,43),CSize(16,16))
btn_ok.Skin.MouseOverImage.Border=CRect(7,7,7,7)
...
lbl_vertical_sync.Skin=StaticSkin()
lbl_vertical_sync.Skin.FontPath="font/SourceHanSansCN-Regular.otf"
...
cbx_vertical_sync.Skin.Image.Rect=CRect(CPoint(52,43),CSize(16,16))
cbx_vertical_sync.Skin.Image.Border=CRect(7,7,7,7)
cbx_vertical_sync.Skin.FontPath="font/SourceHanSansCN-Regular.otf"
...
cbx_vertical_sync.Skin.DisabledImage.Rect=CRect(CPoint(1,43),CSize(16,16))
cbx_vertical_sync.Skin.DisabledImage.Border=CRect(7,7,7,7)
cbx_vertical_sync.Skin.PressedImage=ControlImage()
cbx_vertical_sync.Skin.PressedImage.TexturePath="texture/CommonUI.png"
cbx_vertical_sync.Skin.PressedImage.Rect=CRect(CPoint(18,43),CSize(16,16))
cbx_vertical_sync.Skin.PressedImage.Border=CRect(7,7,7,7)
cbx_vertical_sync.Skin.MouseOverImage=ControlImage()
cbx_vertical_sync.Skin.MouseOverImage.TexturePath="texture/CommonUI.png"
cbx_vertical_sync.Skin.MouseOverImage.Rect=CRect(CPoint(35,43),CSize(16,16))
cbx_vertical_sync.Skin.MouseOverImage.Border=CRect(7,7,7,7)
cbx_vertical_sync.Skin.DropdownImage=ControlImage()
cbx_vertical_sync.Skin.DropdownImage.TexturePath="texture/CommonUI.png"
cbx_vertical_sync.Skin.DropdownImage.Rect=CRect(CPoint(52,43),CSize(16,16))
cbx_vertical_sync.Skin.DropdownImage.Border=CRect(7,7,7,7)
...
cbx_vertical_sync.Skin.DropdownItemMouseOverImage.Rect=CRect(CPoint(35,43),CSize(16,16))
cbx_vertical_sync.Skin.DropdownItemMouseOverImage.Border=CRect(7,7,7,7)
...
cbx_vertical_sync.ScrollBar.Skin.UpBtnNormalImage.Rect=CRect(CPoint(52,43),CSize(16,16))
cbx_vertical_sync.ScrollBar.Skin.UpBtnNormalImage.Border=CRect(7,7,7,7)
...
cbx_vertical_sync.ScrollBar.Skin.UpBtnDisabledImage.Rect=CRect(CPoint(1,43),CSize(16,16))
cbx_vertical_sync.ScrollBar.Skin.UpBtnDisabledImage.Border=CRect(7,7,7,7)
...
cbx_vertical_sync.ScrollBar.Skin.DownBtnNormalImage.Rect=CRect(CPoint(52,43),CSize(16,16))
cbx_vertical_sync.ScrollBar.Skin.DownBtnNormalImage.Border=CRect(7,7,7,7)
...
cbx_vertical_sync.ScrollBar.Skin.DownBtnDisabledImage.Rect=CRect(CPoint(1,43),CSize(16,16))
cbx_vertical_sync.ScrollBar.Skin.DownBtnDisabledImage.Border=CRect(7,7,7,7)
...
cbx_vertical_sync.ScrollBar.Skin.ThumbBtnNormalImage.Rect=CRect(CPoint(52,43),CSize(16,16))
cbx_vertical_sync.ScrollBar.Skin.ThumbBtnNormalImage.Border=CRect(7,7,7,7)
...
cbx_vertical_sync.ScrollBar.Skin.Image.Rect=CRect(CPoint(1,43),CSize(16,16))
cbx_vertical_sync.ScrollBar.Skin.Image.Border=CRect(7,7,7,7)
...
chx_windowed.Skin.Image.Rect=CRect(CPoint(135,43),CSize(20,20))
chx_windowed.Skin.Image.Border=CRect(0,0,0,0)
chx_windowed.Skin.FontPath="font/SourceHanSansCN-Regular.otf"
...
chx_windowed.Skin.DisabledImage.Rect=CRect(CPoint(69,43),CSize(20,20))
chx_windowed.Skin.DisabledImage.Border=CRect(0,0,0,0)
chx_windowed.Skin.PressedImage=ControlImage()
chx_windowed.Skin.PressedImage.TexturePath="texture/CommonUI.png"
chx_windowed.Skin.PressedImage.Rect=CRect(CPoint(91,43),CSize(20,20))
chx_windowed.Skin.PressedImage.Border=CRect(0,0,0,0)
chx_windowed.Skin.MouseOverImage=ControlImage()
chx_windowed.Skin.MouseOverImage.TexturePath="texture/CommonUI.png"
chx_windowed.Skin.MouseOverImage.Rect=CRect(CPoint(113,43),CSize(20,20))
chx_windowed.Skin.MouseOverImage.Border=CRect(0,0,0,0)
