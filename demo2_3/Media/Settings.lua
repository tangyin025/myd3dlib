...
chx_windowed.Skin.Image.Rect=CRect(CPoint(135,43),CSize(21,21))
chx_windowed.Skin.Image.Border=CRect(21,21,0,0)
...
chx_windowed.Skin.DisabledImage.Rect=CRect(CPoint(69,43),CSize(21,21))
chx_windowed.Skin.DisabledImage.Border=CRect(21,21,0,0)
chx_windowed.Skin.PressedImage=ControlImage()
chx_windowed.Skin.PressedImage.TexturePath="texture/CommonUI.png"
chx_windowed.Skin.PressedImage.Rect=CRect(CPoint(91,43),CSize(21,21))
chx_windowed.Skin.PressedImage.Border=CRect(21,21,0,0)
chx_windowed.Skin.MouseOverImage=ControlImage()
chx_windowed.Skin.MouseOverImage.TexturePath="texture/CommonUI.png"
chx_windowed.Skin.MouseOverImage.Rect=CRect(CPoint(113,43),CSize(21,21))
chx_windowed.Skin.MouseOverImage.Border=CRect(21,21,0,0)
