...
acts={}
local terrain=Terrain(NamedObject.MakeUniqueName("terrain"),64,64,128,0.01)
...
local act=Actor(NamedObject.MakeUniqueName("act"),Vector3(-4096,0,-4096),Quaternion.Identity(),Vector3(1,1,1),AABB(0,-4096,0,8192,4096,8192))
...
mesh_cmp.MeshPath="mesh/Cube.mesh.xml"
...
local act=Actor(NamedObject.MakeUniqueName("act"),
