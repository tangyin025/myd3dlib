...
public:
		...
		const D3DSURFACE_DESC * pBackBufferSurfaceDesc)
	{
		...
		//lambert2->m_MeshTexture.m_Path = "texture/wall.jpg";
		//lambert2->m_NormalTexture.m_Path = "texture/wall_NM_height.DDS";
		//lambert2->m_SpecularTexture.m_Path = "texture/White.dds";
