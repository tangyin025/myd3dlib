...
void Export2Lua(lua_State * L)
{
	...
	[
		...
		, class_<ResourceMgrEx, my::ResourceMgr>("ResourceMgrEx")
			.def("LoadMaterialAsync", &ResourceMgrEx::LoadMaterialAsync)
			.def("LoadMaterial", &ResourceMgrEx::LoadMaterial)
			.def("SaveMaterial", &ResourceMgrEx::SaveMaterial)
		...
		, class_<Game, bases<my::DxutApp, ResourceMgrEx> >("Game")
