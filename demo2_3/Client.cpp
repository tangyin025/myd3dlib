	...
	, m_ShowCursorCount(0)
{
	...
	desc.add_options()
		...
		("physxmaxlowedtimestep", boost::program_options::value(&m_MaxAllowedTimestep)->default_value(0.1f), "Physx Max Allowed Timestep")
	...
	const D3DSURFACE_DESC * pBackBufferSurfaceDesc)
{
	...
	DialogMgr::SetDlgViewport(Vector2(m_WindowBackBufferHeightAtModeChange * boost::dynamic_pointer_cast<my::PerspectiveCamera>(m_Camera)->m_Aspect, m_WindowBackBufferHeightAtModeChange), D3DXToRadian(75.0f));
