	...
	, m_ViewedCenter(0, 0, 0)
{
	...
	desc.add_options()
		...
		("physxsceneflags", boost::program_options::value(&m_InitPhysxSceneFlags)->default_value(physx::PxSceneFlag::eENABLE_PCM | physx::PxSceneFlag::eENABLE_ACTIVETRANSFORMS /*| physx::PxSceneFlag::eEXCLUDE_KINEMATICS_FROM_ACTIVE_ACTORS*/ | physx::PxSceneFlag::eENABLE_CCD), "Physx Scene Flags")
