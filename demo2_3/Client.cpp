	...
	[
		...
		, luabind::class_<PlayerData, my::DeviceResourceBase, boost::shared_ptr<my::DeviceResourceBase> >("PlayerData")
			...
			[
				...
				luabind::value("ATTR_WEAPON_COST0", 6),
				luabind::value("ATTR_WEAPON_COST1", 7),
				luabind::value("ATTR_WEAPON_COST2", 8),
				luabind::value("ATTR_HEALTH", 9),
				luabind::value("ATTR_MAX_HEALTH", 10),
				luabind::value("ATTR_ITEM_CAPACITY", 11),
				luabind::value("ATTR_NPC_GROUP_BEGIN", 100),
				luabind::value("ATTR_NPC_GROUP_END", 199),
				luabind::value("ATTR_QUEST_GROUP_BEGIN", 200),
				luabind::value("ATTR_QUEST_GROUP_END", 299),
