...
void LuaContext::Init(void)
{
	...
	module(m_State)[
		...
		, class_<ActionTrackSphericalEmitter, ActionTrack, boost::shared_ptr<ActionTrack> >("ActionTrackSphericalEmitter")
			...
			.def_readwrite("HalfSpawnArea", &ActionTrackSphericalEmitter::m_HalfSpawnArea)
			.def_readwrite("SpawnSpeed", &ActionTrackSphericalEmitter::m_SpawnSpeed)
			.def_readwrite("SpawnInclination", &ActionTrackSphericalEmitter::m_SpawnInclination)
			.def_readwrite("SpawnAzimuth", &ActionTrackSphericalEmitter::m_SpawnAzimuth)
			.def_readwrite("SpawnColorR", &ActionTrackSphericalEmitter::m_SpawnColorR)
			.def_readwrite("SpawnColorG", &ActionTrackSphericalEmitter::m_SpawnColorG)
			.def_readwrite("SpawnColorB", &ActionTrackSphericalEmitter::m_SpawnColorB)
			.def_readwrite("SpawnColorA", &ActionTrackSphericalEmitter::m_SpawnColorA)
			.def_readwrite("SpawnSizeX", &ActionTrackSphericalEmitter::m_SpawnSizeX)
			.def_readwrite("SpawnSizeY", &ActionTrackSphericalEmitter::m_SpawnSizeY)
			.def_readwrite("SpawnAngle", &ActionTrackSphericalEmitter::m_SpawnAngle)
	];
}
