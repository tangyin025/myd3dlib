...
void Export2Lua(lua_State * L)
{
	...
	[
		...
		, class_<my::EmitterParameter<int>, my::Spline, boost::shared_ptr<my::EmitterParameter<int> > >("EmitterParameterInt")
			.def(constructor<int>())
			.def_readwrite("ConstantValue", &my::EmitterParameter<int>::m_ConstantValue)
		...
		, class_<my::EmitterParameter<float>, my::Spline, boost::shared_ptr<my::EmitterParameter<float> > >("EmitterParameterFloat")
			...
			.def_readwrite("ConstantValue", &my::EmitterParameter<float>::m_ConstantValue)
		...
		, class_<my::Emitter, boost::shared_ptr<my::Emitter> >("Emitter")
			...
			, class_<my::AutoSpawnEmitter, my::Emitter, boost::shared_ptr<my::Emitter> >("AutoSpawnEmitter")
			.def(constructor<>())
			.def_readwrite("Position", &my::AutoSpawnEmitter::m_Position)
			.def_readwrite("Orientation", &my::AutoSpawnEmitter::m_Orientation)
			.def_readonly("Time", &my::AutoSpawnEmitter::m_Time)
			.def_readwrite("SpawnInterval", &my::AutoSpawnEmitter::m_SpawnInterval)
			.def_readwrite("RemainingSpawnTime", &my::AutoSpawnEmitter::m_RemainingSpawnTime)
			.def_readwrite("HalfSpawnArea", &my::AutoSpawnEmitter::m_HalfSpawnArea)
			.def_readwrite("SpawnSpeed", &my::AutoSpawnEmitter::m_SpawnSpeed)
			.def_readwrite("SpawnInclination", &my::AutoSpawnEmitter::m_SpawnInclination)
			.def_readwrite("SpawnAzimuth", &my::AutoSpawnEmitter::m_SpawnAzimuth)
			.def_readwrite("SpawnLoopTime", &my::AutoSpawnEmitter::m_SpawnLoopTime)
