...
void LuaContext::Init(void)
{
	...
	module(m_State)[
		...
		, class_<ActionTrackEmitter, ActionTrack, boost::intrusive_ptr<ActionTrack> >("ActionTrackEmitter")
			...
			.def_readwrite("ParticleMaterial", &ActionTrackEmitter::m_ParticleMaterial)
			.def_readwrite("ParticleCapacity", &ActionTrackEmitter::m_ParticleCapacity)
			.def_readwrite("ParticleFaceType", &ActionTrackEmitter::m_ParticleFaceType)
			.def_readwrite("ParticleLifeTime", &ActionTrackEmitter::m_ParticleLifeTime)
			.def_readwrite("SpawnInterval", &ActionTrackEmitter::m_SpawnInterval)
			.def_readwrite("SpawnLength", &ActionTrackEmitter::m_SpawnLength)
