...
void LuaContext::Init(void)
{
	...
	module(m_State)[
		...
		, class_<ActionTrackSphericalEmitter, ActionTrack, boost::intrusive_ptr<ActionTrack> >("ActionTrackSphericalEmitter")
			...
			.def_readwrite("ParticlePosX", &ActionTrackSphericalEmitter::m_ParticlePosX)
			.def_readwrite("ParticlePosY", &ActionTrackSphericalEmitter::m_ParticlePosY)
			.def_readwrite("ParticlePosZ", &ActionTrackSphericalEmitter::m_ParticlePosZ)
			.def_readwrite("ParticleColorR", &ActionTrackSphericalEmitter::m_ParticleColorR)
			.def_readwrite("ParticleColorG", &ActionTrackSphericalEmitter::m_ParticleColorG)
			.def_readwrite("ParticleColorB", &ActionTrackSphericalEmitter::m_ParticleColorB)
			.def_readwrite("ParticleColorA", &ActionTrackSphericalEmitter::m_ParticleColorA)
			.def_readwrite("ParticleSizeX", &ActionTrackSphericalEmitter::m_ParticleSizeX)
			.def_readwrite("ParticleSizeY", &ActionTrackSphericalEmitter::m_ParticleSizeY)
			.def_readwrite("ParticleAngle", &ActionTrackSphericalEmitter::m_ParticleAngle)
	];
}
